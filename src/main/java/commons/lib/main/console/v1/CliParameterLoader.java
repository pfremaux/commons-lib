package commons.lib.main.console.v1;
...
public class CliParameterLoader {
    ...
    public CliParameterLoader(Map<String, String> mandatoryParameters, Map<String, String> optionalParameters, Map<String, String> dependantParameters) {
        if (mandatoryParameters.containsKey("-h") || optionalParameters.containsKey("-h")) {
            throw new IllegalArgumentException("-h parameter is not customized. It's reserved to show a summary of all parameters ot the user.");
        }
